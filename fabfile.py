...
DEPLOYMENT_CONFIGS = [
    ('./deployment/nginx.location', '/usr/local/nginx/conf/vhost/weixintest.location'),
    ('./deployment/logrotate.conf', '/etc/logrotate.d/weixintest.logrotate.conf'),
    # add more
]

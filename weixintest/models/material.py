...
if __name__ == '__main__':
    ...
    news =(
    {
        ...
        [
            {
            "title": "test",
            "thumb_media_id": "hVO0PVdH7yEFlorWCiWAa3xZ8rer4gdg2M_33AfaB6Y",
            "author": "ivan",
            "digest": "",
            "show_cover_pic": 1,
...
#hVO0PVdH7yEFlorWCiWAa3w5m7EeJm8_qL55LbsPYao
if __name__ == '__main__':
    myMaterial = Material()
    accessToken = redis_model.get_access_token()
    mediaType = "news"
    myMaterial.uplaod(accessToken, '/root/text.jpg', mediaType)
